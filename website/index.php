                                ...
                                <div class="row align-items-center no-gutters w-100">
                                    <div class="col-lg-6 col-md-8">
                                        <div class="slider-content py-0">
                                            ...
                                            <div class="slider-content__btn">
                                                <a href="shop.php?Goods_Classify=顯示卡" data-animation="fadeInUp" data-duration=".3s" data-delay=".6s" style="font-size:24px; font-weight:bold; text-decoration: underline;">馬上購買</a>
                                            </div>
                                        </div>
                                    </div>
