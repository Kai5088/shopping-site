...
INSERT INTO `goods` (`Goods_ID`, `Goods_Name`, `Goods_Price`, `Goods_Num`, `Goods_URL`, `Goods_Statement`, `Goods_Classify`) VALUES
(14, 'iRocks K75M 黑色上蓋單色背光機械式鍵盤-茶軸', 2890,
...
INSERT INTO `goods` (`Goods_ID`, `Goods_Name`, `Goods_Price`, `Goods_Num`, `Goods_URL`, `Goods_Statement`, `Goods_Classify`) VALUES
(15, 'Razer DeathAdder V2 Pro Genshin Impact Edition 無線電競滑鼠 [原神聯名款]', 4199,
...
INSERT INTO `goods` (`Goods_ID`, `Goods_Name`, `Goods_Price`, `Goods_Num`, `Goods_URL`, `Goods_Statement`, `Goods_Classify`) VALUES
(16, '【ROG Strix SCAR 15】 G533ZM-0022S12900H 電競筆電', 55990,
